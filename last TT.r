...
around the hours to two decimal places
hours = (round, 2)
#convert the number of hours to full hours plus minutes and seconds
print("it will take", full_days , "days", "+", hours, "hours to fill the")


around the hours to two decimal placeshours = round(hours,2)
full_h = int(hours)
part_h = hours - full_hmin = part_h * 60
#convert the number of hours to full hours plus minutes and seconds
print("it will take", full_days , "days", "+", hours, "hours","+", min,
.)